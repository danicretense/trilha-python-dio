...
class ContaCorrente(Conta):
    def __init__(self, numero, cliente, limite=500, limite_saques=3, limite_trans=3):
        super().__init__(numero, cliente)
        self._limite = limite
        self._limite_saques = limite_saques
        self._limite_trans = limite_trans
        self._numero_saques = 0
        self._numero_trans = 0
    ...
    def transferir(self, valor, conta_destino):
        excedeu_trans = self._numero_trans >= self._limite_trans
...
class Transferencia(Transacao):
    ...
    def registrar(self, conta):
        if conta.transferir(self.valor, self._conta_destino):
            conta.historico.adicionar_transacao(self)
